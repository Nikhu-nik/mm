...
export class EditProfilePage implements OnInit {
  ...
  // public base64temp : string = '../../assets/icon/user-avatar.png';
...
constructor(private fb:FormBuilder
    ,private rest:RestService,private fileChooser: FileChooser,
    public camera: Camera,
    private filePath:FilePath,
    public file:File,public alertService:AlertService,
...
vali(){
  ...
  getuserprofiles() {
    this.rest.userprofile().subscribe((result) => {
      if (result === undefined) {
        ...
        this.base64temp = "http://localhost:3000/"+this.userid.profilephoto;
     // this.base64temp= this.userid.profilephoto;
  ...
  if (this.formcontrol.valid) {
    ...
    this.data["profilephoto"] = this.myprofile;
    this.data["userId"] = this.rest.getId();

    console.log(this.data);
    if (this.formcontrol.valid) {
      this.rest.Updateprofile(this.data).subscribe((result) => {
       // this.upload();
        console.log(result);
        if (result === undefined) {
          console.log(result);  
         ...
         this.alertService.profileupdatedalert();
